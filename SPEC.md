...
The middleware uses a compact, static MIME table with ASCII case-insensitive extension matching and an optional, linearly searched slice of user overrides; it does not generate or allocate a runtime MIME registry. Override extensions and content types are validated during initialization, duplicate override extensions are rejected case-insensitively, and override configuration is retained for the middleware lifetime.
